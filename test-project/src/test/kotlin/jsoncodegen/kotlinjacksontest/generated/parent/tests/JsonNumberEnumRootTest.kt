...
data class JsonNumberEnumRootTest(
	...
	val arrayOfArraysOfEnums: List<List<jsoncodegen.kotlinjacksontest.generated.JsonNumberEnum>>,
	...
	val mapOfMapsOfEnums: Map<String, Map<String, jsoncodegen.kotlinjacksontest.generated.JsonNumberEnum>>,
