...
data class JsonInterfaceSiblingTest(
	...
	val arrayOfArraysOfObjects: List<List<jsoncodegen.kotlinjacksontest.generated.parent.sibling.JsonInterface>>,
	...
	val mapOfMapsOfObjects: Map<String, Map<String, jsoncodegen.kotlinjacksontest.generated.parent.sibling.JsonInterface>>,
