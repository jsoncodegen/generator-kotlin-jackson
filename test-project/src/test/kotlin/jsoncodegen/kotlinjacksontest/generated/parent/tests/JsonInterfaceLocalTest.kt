...
data class JsonInterfaceLocalTest(
	...
	val arrayOfArraysOfObjects: List<List<jsoncodegen.kotlinjacksontest.generated.parent.tests.JsonInterface>>,
	...
	val mapOfMapsOfObjects: Map<String, Map<String, jsoncodegen.kotlinjacksontest.generated.parent.tests.JsonInterface>>,
